    ...
    render() {
        return (
            <div>
                ...
                <div id='flexo' className="class">
                    ...
                    <div className="row">
                        ...
                        <ul id="class-filter">
                            ...
                            {/***************/}
                            <li data-filter="*"><a href='#flexo'>Flex printing</a></li>
                            <li data-filter=".filter-1"><a href='#enlarget'>Photo enlargement</a></li>
                            <li data-filter=".filter-2"><a href='#stickerpt'>Sticker printing</a></li>
                            <li data-filter=".filter-3"><a href='#fabricf'>Fabric printing</a></li>
                            <li data-filter=".filter-4"><a href='#pvpf'>PV paper printing</a></li>
                ...
                {/*************/}
                {/* Class Start */}
                <div id='enlarget' className="class">
                    {/* <div className="containeri"> */}
                    <div className="container ct">
                    <div
                        className="section-header text-center wow zoomIn"
                ...
                {/*************/}
                {/* Class Start */}
                <div id='stickerpt' className="class">
                    {/* <div className="containeri"> */}
                    <div className="container ct">
                    <div
                        className="section-header text-center wow zoomIn"
                ...
                {/*************/}
                {/* Class Start */}
                <div id='fabricf' className="class">
                    {/* <div className="containeri"> */}
                    <div className="container ct">
                    <div
                        className="section-header text-center wow zoomIn"
